...
.. _GitHub: https://github.com/dls-controls/dls_bluesky_commissioning/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/dls_bluesky_commissioning.git
    $ cd dls_bluesky_commissioning
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/dls-controls/dls_bluesky_commissioning/releases
